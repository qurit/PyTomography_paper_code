...
np.save(os.path.join(output_path, 'pet_gate_experiment', 'pet_recon1.npy'), recon.cpu().numpy())
with open(os.path.join(output_path, 'pet_gate_experiment', 'pet_recon1_callback'), 'wb') as f:
    pickle.dump(cb, f)
